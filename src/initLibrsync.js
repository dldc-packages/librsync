 ...
 * @returns {Uint8Array}
 */
export function signature(data, block_size, crypto_hash_size) {
 ...
 * @returns {Uint8Array}
 */
export function diff(signature, new_data) {
    const ptr0 = passArray8ToWasm0(signature, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(new_data, wasm.__wbindgen_malloc);
 ...
 * @returns {Uint8Array}
 */
export function apply(base_data, patch) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('librsync_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
